---
layout:     post
title:      "Rails API Tutorial, Part 4: HTTP Status Codes"
date:       2020-07-09 07:15:00 +0000
permalink:  'rails-api-tutorial-part-4-http-status-codes'
---
...
<style>.embed-container { position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden; max-width: 100%; } .embed-container iframe, .embed-container object, .embed-container embed { position: absolute; top: 0; left: 0; width: 100%; height: 100%; }</style><div class='embed-container'><iframe src='https://www.youtube.com/embed//yZM4oRZvltU' frameborder='0' allowfullscreen></iframe></div>
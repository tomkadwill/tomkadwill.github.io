---
layout:     post
title:      "Rails API Tutorial, Part 7: Exception Handling in Controllers"
date:       2020-08-10 06:48:00 +0000
permalink:  'rails-api-tutorial-part-7-exception-handling-in-controllers'
---
...
<style>.embed-container { position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden; max-width: 100%; } .embed-container iframe, .embed-container object, .embed-container embed { position: absolute; top: 0; left: 0; width: 100%; height: 100%; }</style><div class='embed-container'><iframe src='https://www.youtube.com/embed//RQQ98mbh2Ic' frameborder='0' allowfullscreen></iframe></div>
